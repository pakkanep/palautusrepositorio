...
class TestIntJoukko(unittest.TestCase):
    ...
    def toimii_kasvatuksen_jalkeen(self, joukko):
        ...
        self.assertTrue(joukko.luku_kuuluu_listaan(11))
        joukko.poista(11)
        self.assertFalse(joukko.luku_kuuluu_listaan(11))
    ...
    def test_vain_lisatyt_luvut_loytyvat(self):
        self.assertTrue(self.joukko.luku_kuuluu_listaan(10))
        self.assertFalse(self.joukko.luku_kuuluu_listaan(5))
        self.assertTrue(self.joukko.luku_kuuluu_listaan(3))

    def test_poistettu_ei_ole_enaa_joukossa(self):
        self.joukko.poista(3)
        self.assertFalse(self.joukko.luku_kuuluu_listaan(3))
    ...
    def test_palautetaan_oikea_taulukko(self):
        ...
        vastaus = self.joukko.kokonaisluku_listaksi()
    ...
    def test_yhdiste(self):
        ...
        vastauksen_luvut = tulos.kokonaisluku_listaksi()
